      ...
      <div className="record-detail-card">
          ...
          <div className="worker-profile-fields">
            <div className="worker-profile-field">
              <span className="worker-profile-label">
                {t("worker.recordDetail.category")}
              </span>
            ...
            {record.hospitalName && (
              <div className="worker-profile-field">
                <span className="worker-profile-label">
                  {t("worker.recordDetail.hospital")}
                </span>
                <span className="worker-profile-value">
                  {record.hospitalName}
                </span>
          ...
          <div className="record-detail-section">
            ...
            <div className="worker-profile-fields">
              {record.diagnosis?.length > 0 && (
                <div className="worker-profile-field">
                  <span className="worker-profile-label">
                    {t("worker.recordDetail.diagnosis")}
                  </span>
                  <span className="worker-profile-value">
              ...
              {record.prescriptions?.length > 0 && (
                <div className="worker-profile-field">
                  <span className="worker-profile-label">
                    {t("worker.recordDetail.prescriptions")}
                  </span>
                  <span className="worker-profile-value">
              ...
              {record.followUpPlan && (
                <div className="worker-profile-field">
                  <span className="worker-profile-label">
                    {t("worker.recordDetail.followUpPlan")}
                  </span>
                  <span className="worker-profile-value">
                    {record.followUpPlan}
                  </span>
        ...
        <div className="record-detail-section">
          ...
          <div className="worker-profile-fields">
            <div className="worker-profile-field">
              <span className="worker-profile-label">
                {t("worker.recordDetail.createdBy")}
              </span>
              <span className="worker-profile-value">
                {record.doctorName || "—"}
              </span>
            ...
            <div className="worker-profile-field">
              <span className="worker-profile-label">
                {t("worker.recordDetail.createdAt")}
              </span>
              <span className="worker-profile-value">
